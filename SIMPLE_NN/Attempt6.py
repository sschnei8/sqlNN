...
SELECT CURRENT_TIMESTAMP AS INSERT_TIME
     ...
     , CASE WHEN OUTPUT_NODE = 1 THEN .25
            WHEN OUTPUT_NODE = 2 THEN .75 END AS ACTUAL_VALUE
FROM L2_ACTIVATION
)
"""
...
SELECT W.HIDDEN_LAYER
     ...
     , W.WEIGHT - (0.1 * CLIPPED_GRADIENT) AS UPDATED_WEIGHT -- LEARNING RATE OF .1
...
SELECT L.INPUT_NODE
     ...
     , L.WEIGHT
     , A.NET_W
     , L.WEIGHT - (0.1 * A.NET_W) AS UPDATED_WEIGHT
